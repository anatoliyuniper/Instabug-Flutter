...
void SessionReplayHostApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<SessionReplayHostApi> *api) {
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.SessionReplayHostApi.setEnabled"
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.SessionReplayHostApi.setNetworkLogsEnabled"
        binaryMessenger:binaryMessenger
        codec:SessionReplayHostApiGetCodec()];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.SessionReplayHostApi.setInstabugLogsEnabled"
        binaryMessenger:binaryMessenger
        codec:SessionReplayHostApiGetCodec()];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.SessionReplayHostApi.setUserStepsEnabled"
        binaryMessenger:binaryMessenger
        codec:SessionReplayHostApiGetCodec()];
    if (api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.SessionReplayHostApi.getSessionReplayLink"
        binaryMessenger:binaryMessenger
        codec:SessionReplayHostApiGetCodec()];
    if (api) {
